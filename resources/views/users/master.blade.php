...
<div class="container">
		<div class="head">
			<div class=" logo">
				<a href='/'><img src="{{ asset('user_assest/images/logo.png') }}" alt=""></a>	
			</div>
		</div>
	</div>
    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
			...
			<div class="col-sm-2 search-right">
				<ul class="heart">
				<li><a class="play-icon popup-with-zoom-anim" href="#small-dialog"><i class="glyphicon glyphicon-search searchicon"> </i></a></li>
				</ul>
			...
			<form action='{{ url("/seachproduct") }}' method="post" enctype="multipart/form-data">
			{{csrf_field()}}
